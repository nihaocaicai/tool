...
//userController start
	...
	public String userControllerUpdate(@RequestHeader String token, @RequestBody String user_info,
...
//diaryController start
	...
	public String diaryControllerAdd(@RequestHeader String token, @RequestBody String user_diary_add,
			RedirectAttributes attr) {
		String id = RedisUtil.getJedis().get(token);
		attr.addFlashAttribute("id", id);
...
//		System.out.println(user_diary_add);
	...
	public String diaryControllerModify(@RequestHeader String token, @RequestBody String user_diary_modify,
			RedirectAttributes attr) {
		String id = RedisUtil.getJedis().get(token);
		attr.addFlashAttribute("id", id);
...
//arrangementController start
	...
	public String arrangementControllerAdd(@RequestHeader String token, @RequestBody String user_arrangement_add,
			RedirectAttributes attr) {
		String id = RedisUtil.getJedis().get(token);
		attr.addFlashAttribute("id", id);
	...
	public String arrangementControllerModify(@RequestHeader String token, @RequestBody String user_arrangement_modify,
			RedirectAttributes attr) {
		String id = RedisUtil.getJedis().get(token);
		attr.addFlashAttribute("id", id);
...
//planController start
	...
	public String planControllerModify(@RequestHeader String token, @RequestBody String user_plan_modify,
			RedirectAttributes attr) {
		String id = RedisUtil.getJedis().get(token);
		attr.addFlashAttribute("id", id);
