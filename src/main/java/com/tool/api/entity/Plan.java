...
public class Plan {
	...
	public Plan(int user_id,String plan_content,Date plan_date,String plan_start_time,String plan_end_time,int plan_if_repeat,int plan_if_finish) {
		super();
		this.user_id=user_id;
	...
	public Plan(int plan_id,int user_id,String plan_content,Date plan_date,String plan_start_time,String plan_end_time,int plan_if_repeat,int plan_if_finish) {
		super();
